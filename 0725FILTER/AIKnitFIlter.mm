...
- (UIImage*)adjustmentFilter:(UIImage*)sourceImage{
    ...
    [ssPosterizeFilter setColorLevels:5];
...
-(UIImage*)textureFilter:(UIImage*)sourceImage{
 ...
 [txBlurFilter addTarget:txContrastFilter];
 [txContrastFilter useNextFrameForImageCapture];
 [imagePicture processImage];
 
 UIImage* textureImage = [txContrastFilter imageFromCurrentFramebuffer];
     return textureImage;
 }
